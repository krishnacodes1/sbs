    ...
    <div className="carousel-container">
      <Slider {...settings}>
        ...
        <div className="carousel-item">
          <img
            className=" bg-black"
            src="	http://sbsjaunpur.in/bannar/images/3.jpg"
            alt="Image 3"
          />
          <div class="custom-shape-divider-bottom-1691595857">
            <svg
        ...
        <div className="carousel-item">
          <img
            className=" bg-black"
            src="	http://sbsjaunpur.in/bannar/images/12.jpg"
            alt="Image 3"
          />
          <div class="custom-shape-divider-bottom-1691595857">
            <svg
        ...
        <div className="carousel-item">
          <img
            className=" bg-black"
            src="	http://sbsjaunpur.in/bannar/images/2.jpg"
            alt="Image 3"
          />
          <div class="custom-shape-divider-bottom-1691595857">
            <svg
        ...
        <div className="carousel-item">
          <img
            className=" bg-black"
            src="	http://sbsjaunpur.in/bannar/images/4.jpg"
            alt="Image 3"
          />
          <div class="custom-shape-divider-bottom-1691595857">
            <svg
